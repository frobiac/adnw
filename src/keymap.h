...
static const struct keycode /*PROGMEM*/ KeyMatrix[LAYERS+2][ROWS][COLS] =
{
    // normal layer
    {
        ...
        { _MOUSE,	_L_GUI,		_ESC,		_MOD_3,		_L_CTRL,	_L_ALT	},
        
        { _MOD_1,	_k,			_g,			_l,			_m,			_f		},
        { _MOD_2,	_h,			_d,			_n,			_r,			_s		},
        { _L_SHIFT, _z,			_y,			_COMMA,		_PERIOD,	_MINUS	},
        { _NO,		_MOD_2,		_L_SHIFT,	_R_ALT,		_R_CTRL,  _COMPOSE	}
		},
    ...
    // MOD1 layer (shifted)
    {
        ...
        { _A,		_I,			_E,			_T,			_C,			_NO		},
        { _NO,		_J,			_X,			_W,			_V,			_NO		},
        { _MOUSE,	_L_GUI,		_L_ALT,		_MOD_3,		_L_CTRL,	_NO		},
        
        { _NO,		_K,			_G,			_L,			_M,			_F		},
        { _NO,		_H,			_D,			_N,			_R,			_S		},
		{ _NO,		_Z,			_Y,			_SCOLON,	_COLON,		_USCORE },
        { _NO,		_MOD_2,		_L_SHIFT,	_R_ALT,		_NO,		_COMPOSE}
    },	
	...
	//MOUSE MODE
    {
		...
		{ _a,		_i,			_e,			_t,			_c,		_NO		},
		{ _NO,		_j,			_x,			_w,			_v,		_NO		},
		{ _MOUSE,	_L_GUI,		_L_ALT,		_MOD_3,		_L_CTRL,_TAB	},
