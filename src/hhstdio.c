...
//    /* 39  ' */ { NONE, 0, { USAGE_ID(HID_USAGE_SQUOTE_AND_DQUOTE) }},
    /* 39  ' */ { L_SHF, 0, { USAGE_ID(HID_USAGE_NONUS__BACKSLASH_AND__PIPE) }},
...
//    /* 42  * */ { L_SHF, 0, { USAGE_ID(HID_USAGE_8_AND__ASTERISK) }},
    /* 42  * */ { L_SHF, 0, { USAGE_ID(HID_USAGE_9_AND__LPAREN) }},
...
//  /* 60  < */ { L_SHF, 0, { USAGE_ID(HID_USAGE__COMMA_AND__LESSTHAN) }},
    /* 60  < */ { NONE, 0, { USAGE_ID(HID_USAGE_NONUS__POUND_AND__TILDE) }},
...
//  /* 62  > */ { L_SHF, 0, { USAGE_ID(HID_USAGE__PERIOD_AND__GREATERTHAN) }},
    /* 62  > */ { L_SHF, 0, { USAGE_ID(HID_USAGE_NONUS__POUND_AND__TILDE) }},
