...
//  /* 34  " */ { L_SHF, 0, { USAGE_ID(HID_USAGE_SQUOTE_AND_DQUOTE) }},
    /* 34  " */ { L_SHF, 0, { USAGE_ID(HID_USAGE_2_AND__ATSIGN) }},
// /* 35  # */ { L_SHF, 0, { USAGE_ID(HID_USAGE_3_AND__POUND)  }},
    /* 35  # */ { NONE, 0, { USAGE_ID(HID_USAGE__BACKSLASH_AND__PIPE)  }},
...
//    /* 58  : */ { L_SHF, 0, { USAGE_ID(HID_USAGE__SEMICOLON_AND__COLON) }},
    /* 58  : */ { L_SHF, 0, { USAGE_ID(HID_USAGE__PERIOD_AND__GREATERTHAN) }},
//    /* 59  ; */ { NONE, 0, { USAGE_ID(HID_USAGE__SEMICOLON_AND__COLON) }},
    /* 59  ; */ { L_SHF, 0, { USAGE_ID(HID_USAGE__COMMA_AND__LESSTHAN) }},
//  /* 60  < */ { L_SHF, 0, { USAGE_ID(HID_USAGE__COMMA_AND__LESSTHAN) }},
    /* 60  < */ { NONE, 0, { USAGE_ID(HID_USAGE_NONUS__BACKSLASH_AND__PIPE) }},
//    /* 61  = */ { NONE, 0, { USAGE_ID(HID_USAGE__EQUALS_AND__PLUS) }},
    /* 61  = */ { L_SHF, 0, { USAGE_ID(HID_USAGE_0_AND__RPAREN) }},
//  /* 62  > */ { L_SHF, 0, { USAGE_ID(HID_USAGE__PERIOD_AND__GREATERTHAN) }},
    /* 62  > */ { L_SHF, 0, { USAGE_ID(HID_USAGE_NONUS__BACKSLASH_AND__PIPE) }},
//  /* 63  ? */ { L_SHF, 0, { USAGE_ID(HID_USAGE__SLASH_AND__QUESTION) }},
    /* 63  ? */ { L_SHF, 0, { USAGE_ID(HID_USAGE__MINUS_AND_UNDERSCORE) }},

//    /* 64  @ */ { L_SHF, 0, { USAGE_ID(HID_USAGE_2_AND__ATSIGN) }},
    /* 64  @ */ { R_ALT, 0, { USAGE_ID(HID_USAGE_Q_AND_Q) }},
...
//    /* 91  [ */ { NONE, 0, { USAGE_ID(HID_USAGE__LSQUAREBRACKET_AND__LCURLYBRACE) }},
    /* 91  [ */ { R_ALT, 0, { USAGE_ID(HID_USAGE_8_AND__ASTERISK) }},
//    /* 92  \ */ { NONE, 0, { USAGE_ID(HID_USAGE__BACKSLASH_AND__PIPE) }},
    /* 92  \ */ { R_ALT, 0, { USAGE_ID(HID_USAGE__MINUS_AND_UNDERSCORE) }},
    /* 93  ] */ { R_ALT, 0, { USAGE_ID(HID_USAGE_9_AND__LPAREN) }},
//    /* 94  ^ */ { L_SHF, 0, { USAGE_ID(HID_USAGE_6_AND__CARET) }},
    /* 94  ^ */ { NONE, 0, { USAGE_ID(HID_USAGE__BACKTICK_AND__TILDE) }},
...
//    /* 121 y */ { NONE, 0, { USAGE_ID(HID_USAGE_Y_AND_Y) }},
    /* 121 y */ { NONE, 0, { USAGE_ID(HID_USAGE_Z_AND_Z) }},
//    /* 122 z */ { NONE, 0, { USAGE_ID(HID_USAGE_Z_AND_Z) }},
    /* 122 z */ { NONE, 0, { USAGE_ID(HID_USAGE_Y_AND_Y) }},
//    /* 123 { */ { L_SHF, 0, { USAGE_ID(HID_USAGE__LSQUAREBRACKET_AND__LCURLYBRACE) }},
    /* 123 { */ { R_ALT, 0, { USAGE_ID(HID_USAGE_7_AND__AMPERSAND) }},
//    /* 124 | */ { L_SHF, 0, { USAGE_ID(HID_USAGE__BACKSLASH_AND__PIPE) }},
    /* 124 | */ { R_ALT, 0, { USAGE_ID(HID_USAGE_NONUS__BACKSLASH_AND__PIPE) }},
//    /* 125 } */ { L_SHF, 0, { USAGE_ID(HID_USAGE__RSQUAREBRACKET_AND__RCURLYBRACE) }},
    /* 125 } */ { R_ALT, 0, { USAGE_ID(HID_USAGE_0_AND__RPAREN) }},
//    /* 126 ~ */ { L_SHF, 0, { USAGE_ID(HID_USAGE__BACKTICK_AND__TILDE) }},
    /* 126 ~ */ { R_ALT, 0, { USAGE_ID(HID_USAGE__RSQUAREBRACKET_AND__RCURLYBRACE) }},
};
